 ...
 * 重写es部分
 * 114行 配置服务器和端口
 * 129行 配置 es 的集群名称  "cluster.name"："name"
 * 134行 配置用户名和密码
 */
...
public class TransportClientFactoryBean implements FactoryBean<TransportClient>, InitializingBean, DisposableBean {
    ...
    //    public TransportClientFactoryBean(ElasticsearchProperties properties) {
...
//        }
        return Settings.builder().put("cluster.name", "docker-cluster").put("client.transport.sniff", clientTransportSniff)
